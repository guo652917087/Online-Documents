...
1. [产品介绍](#产品介绍)
2. [产品优势](#产品优势)
3. [GW8000系列网关参数对比](#GW8000系列网关参数对比)
4. [硬件版本说明](#硬件版本说明)
	- [1. IMX93-2-470F-x.x.x(CN470 全双工版本)](#1. IMX93-2-470F-x.x.x(CN470 全双工版本))
	- [2. IMX93-2-868-x.x.x(EU868 LBT 版本)](#2. IMX93-2-868-x.x.x(EU868 LBT 版本))
	- [3. IMX93-2-915-x.x.x(US915/AS923 LBT 版本)](#3. IMX93-2-915-x.x.x(US915/AS923 LBT 版本))	
5. [软件功能特性](#软件功能特性)
6. [系统架构](#系统架构)
7. [登录网关页面](#登录网关页面)
8. [WAN口静态IP配置](#WAN口静态IP配置)
9. [配置LoRa通信模式](#配置LoRa通信模式)
10. [内置Chirpstack设备管理](#内置chirpstack设备管理)
11. [数据采集示例](#数据采集示例)
12. [高级Web管理功能](#高级web管理功能)
13. [FUOTA固件空中升级](#fuota固件空中升级)
14. [网关集群管理](#网关集群管理)
15. [产品竞争力总结](#产品竞争力总结)
